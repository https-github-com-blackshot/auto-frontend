...
import {ServiceMaintenanceService} from '../../features/service-maintenance/service-maintenance.service';
...
export class DashboardComponent implements OnInit, OnDestroy {
    ...
    serviceMaintenanceList: ServiceMaintenance[] = [];
    ...
    loadAllServiceBooks(): void {
        this._userProfileService.getAllServiceBook().pipe(takeUntil(this._unsubscribeAll)).subscribe((res) => {
            this.serviceBookList = res;
        });
    }
